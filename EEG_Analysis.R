...
eeg_select_glmulti <- glmulti(y ~ X4+X24+X100, data=eeg_select, name="glmulti.analysis", intercept = TRUE, marginality = FALSE, plotty=TRUE)
summary(eeg_select_glmulti)
plot.glmulti(eeg_select_glmulti)
##
eeg_select_glmulti_2 <- glmulti(y ~ X4+X10+X24+X102, data=eeg_select, name="glmulti.analysis", intercept = TRUE, marginality = FALSE, plotty=TRUE)
summary(eeg_select_glmulti_2)
plot.glmulti(eeg_select_glmulti_2)
