...
eeg_pca_out <- eeg_pca_out[, -(51:178)]
View(eeg_pca_out)
...
eeg_pca_out_all <- eeg_pca_out_all[, -(51:178)]
eeg_pca_out_all <- eeg_pca_out_all[, -51]
...
eeg_pca_logit <- glm(y ~ Comp.1+Comp.5+Comp.6+Comp.7+Comp.8+Comp.9+Comp.12+Comp.13+Comp.17+Comp.19+Comp.20+Comp.21+Comp.22+Comp.26+Comp.29+Comp.37+Comp.38+Comp.40+Comp.41+Comp.43+Comp.46+Comp.47, data=eeg_pca_out, family="binomial")
